...
import { default as DefaultUseCase } from "@data-hub/videos-catalog/@core/@seedwork/application/use-case";
import { CastMemberType, Types } from "../../domain";
import { EntityValidationError } from "@data-hub/videos-catalog/@core/@seedwork/domain";

export class CreateCastMemberUseCase implements DefaultUseCase<Input, Output> {
