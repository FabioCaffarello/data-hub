...
import NotFoundError from "@data-hub/videos-catalog/@core/@seedwork/domain/errors/not-found.error";
...
import { EntityValidationError } from "@data-hub/videos-catalog/@core/@seedwork/domain";
